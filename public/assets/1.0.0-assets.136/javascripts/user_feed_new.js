...
/******/ 	deferredModules.push([9,"common_vendor","common"]);
...
/***/ "./assets/stylesheets/user_feed/feed_item.scss":
/*!*****************************************************!*\
  !*** ./assets/stylesheets/user_feed/feed_item.scss ***!
  \*****************************************************/
...
/***/ "./assets/stylesheets/user_feed/feed_mast.scss":
/*!*****************************************************!*\
  !*** ./assets/stylesheets/user_feed/feed_mast.scss ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./assets/stylesheets/user_feed/profile_feed.scss":
/*!********************************************************!*\
  !*** ./assets/stylesheets/user_feed/profile_feed.scss ***!
  \********************************************************/
/*! no static exports found */
...
/***/ "./lib/assets/javascripts/dashboard/user-feed.js":
/*!*******************************************************!*\
  !*** ./lib/assets/javascripts/dashboard/user-feed.js ***!
  \*******************************************************/
/*! no static exports found */
...
var ScrollToFix = __webpack_require__(/*! dashboard/helpers/scroll-tofixed-view */ "./lib/assets/javascripts/dashboard/helpers/scroll-tofixed-view.js");
var FavMapView = __webpack_require__(/*! dashboard/views/public-profile/fav-map-view */ "./lib/assets/javascripts/dashboard/views/public-profile/fav-map-view.js");
var Feed = __webpack_require__(/*! dashboard/views/public-profile/feed-view */ "./lib/assets/javascripts/dashboard/views/public-profile/feed-view.js");
...
var Visualizations = __webpack_require__(/*! ./user-feed/feed-collection */ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/feed-collection.js");
...
var feedTemplate = __webpack_require__(/*! ./user-feed/feed.tpl */ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/feed.tpl");
var mapTemplate = __webpack_require__(/*! ./user-feed/map-item.tpl */ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/map-item.tpl");
var datasetTemplate = __webpack_require__(/*! ./user-feed/dataset-item.tpl */ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/dataset-item.tpl");
var loaderTemplatePath = __webpack_require__(/*! ./user-feed/loading.tpl */ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/loading.tpl");
var emptyTemplatePath = __webpack_require__(/*! ./user-feed/empty.tpl */ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/empty.tpl");
var errorTemplatePath = __webpack_require__(/*! ./user-feed/error.tpl */ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/error.tpl");

var REQUIRED_OPTS = ['config', 'authenticatedUser'];
...
module.exports = CoreView.extend({
  ...
  _initBindings: function _initBindings() {
  ...
  _onChangeShowMast: function _onChangeShowMast() {
  ...
  _onChangeShowLoader: function _onChangeShowLoader() {
  ...
  _getDatasetSize: function _getDatasetSize(item) {
  ...
  _renderVisualizations: function _renderVisualizations() {
  ...
  _renderStaticMaps: function _renderStaticMaps() {
  ...
  _renderStaticMap: function _renderStaticMap(vis, $el) {
  ...
  _getLikesEndpoint: function _getLikesEndpoint(vis) {
    return '/api/v1/viz/' + vis.get('id') + '/like';
  },

  _userLoggedIn: function _userLoggedIn() {
    return this._authenticatedUser && !!this._authenticatedUser.get('username');
  },

  _fetchLike: function _fetchLike(model, url) {
  ...
  _fetchItems: function _fetchItems(params) {
    var data = _.extend({
      types: 'table,derived',
      privacy: 'public',
      only_published: 'true',
  ...
  _onFetchError: function _onFetchError() {
    this.model.set({ show_loader: false });
    this._renderError();
  },

  _onClickMore: function _onClickMore(e) {
    this.killEvent(e);
...
/***/ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/dataset-item.tpl":
/*!******************************************************************************************!*\
  !*** ./lib/assets/javascripts/dashboard/views/public-profile/user-feed/dataset-item.tpl ***!
  \******************************************************************************************/
/*! no static exports found */
...
/***/ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/empty.tpl":
/*!***********************************************************************************!*\
  !*** ./lib/assets/javascripts/dashboard/views/public-profile/user-feed/empty.tpl ***!
  \***********************************************************************************/
/*! no static exports found */
...
/***/ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/error.tpl":
/*!***********************************************************************************!*\
  !*** ./lib/assets/javascripts/dashboard/views/public-profile/user-feed/error.tpl ***!
  \***********************************************************************************/
/*! no static exports found */
...
/***/ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/feed-collection.js":
/*!********************************************************************************************!*\
  !*** ./lib/assets/javascripts/dashboard/views/public-profile/user-feed/feed-collection.js ***!
  \********************************************************************************************/
/*! no static exports found */
...
/***/ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/feed.tpl":
/*!**********************************************************************************!*\
  !*** ./lib/assets/javascripts/dashboard/views/public-profile/user-feed/feed.tpl ***!
  \**********************************************************************************/
/*! no static exports found */
...
/***/ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/loading.tpl":
/*!*************************************************************************************!*\
  !*** ./lib/assets/javascripts/dashboard/views/public-profile/user-feed/loading.tpl ***!
  \*************************************************************************************/
/*! no static exports found */
...
/***/ "./lib/assets/javascripts/dashboard/views/public-profile/user-feed/map-item.tpl":
/*!**************************************************************************************!*\
  !*** ./lib/assets/javascripts/dashboard/views/public-profile/user-feed/map-item.tpl ***!
  \**************************************************************************************/
/*! no static exports found */
...
/***/ 9:
/*!**********************************************************************************************************************************************************************************************************!*\
  !*** multi ./lib/assets/javascripts/dashboard/user-feed.js ./assets/stylesheets/user_feed/feed_item.scss ./assets/stylesheets/user_feed/feed_mast.scss ./assets/stylesheets/user_feed/profile_feed.scss ***!
  \**********************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /cartodb/lib/assets/javascripts/dashboard/user-feed.js */"./lib/assets/javascripts/dashboard/user-feed.js");
__webpack_require__(/*! /cartodb/assets/stylesheets/user_feed/feed_item.scss */"./assets/stylesheets/user_feed/feed_item.scss");
__webpack_require__(/*! /cartodb/assets/stylesheets/user_feed/feed_mast.scss */"./assets/stylesheets/user_feed/feed_mast.scss");
module.exports = __webpack_require__(/*! /cartodb/assets/stylesheets/user_feed/profile_feed.scss */"./assets/stylesheets/user_feed/profile_feed.scss");


/***/ })

/******/ });
//# sourceMappingURL=user_feed_new.js.map